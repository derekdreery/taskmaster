...
var $author$project$Tasks$BranchTask = function (a) {
	return {$: 'BranchTask', a: a};
};
var $author$project$Tasks$TaskBranch = F3(
	function (name, expanded, subtasks) {
		return {expanded: expanded, name: name, subtasks: subtasks};
	});
var $author$project$Utils$arraySingleton = function (val) {
	return A2($elm$core$Array$push, val, $elm$core$Array$empty);
};
var $author$project$Tasks$mapTask = F3(
	function (branchMapper, leafMapper, task) {
		if (task.$ === 'BranchTask') {
			var task_ = task.a;
			return branchMapper(task_);
		} else {
			var task_ = task.a;
			return leafMapper(task_);
		}
	});
var $author$project$Tasks$addSubtask = function (subtask) {
	return A2(
		$author$project$Tasks$mapTask,
		function (task) {
			return $author$project$Tasks$BranchTask(
				_Utils_update(
					task,
					{
						subtasks: A2($elm$core$Array$push, subtask, task.subtasks)
					}));
		},
		function (task) {
			return $author$project$Tasks$BranchTask(
				A3(
					$author$project$Tasks$TaskBranch,
					task.name,
					false,
					$author$project$Utils$arraySingleton(subtask)));
		});
};
var $author$project$Tasks$LeafTask = function (a) {
	return {$: 'LeafTask', a: a};
};
var $author$project$Tasks$newTask = function (taskName) {
	return $author$project$Tasks$LeafTask(
		{completed: false, name: taskName});
};
var $author$project$Tasks$dummyTasks = $elm$core$Array$fromList(
	_List_fromArray(
		[
			A2(
			$author$project$Tasks$addSubtask,
			A2(
				$author$project$Tasks$addSubtask,
				$author$project$Tasks$newTask('Read the paper \"10.1001/example.12612\"'),
				$author$project$Tasks$newTask('Read about user centred design')),
			A2(
				$author$project$Tasks$addSubtask,
				$author$project$Tasks$newTask('Read about lymphoma'),
				$author$project$Tasks$newTask('Do reading for lit review'))),
			$author$project$Tasks$newTask('Complete mid-term assignment for epidemiology course'),
			$author$project$Tasks$newTask('Tidy room')
		]));
var $author$project$Main$init = _Utils_Tuple2(
	{editingTask: $elm$core$Maybe$Nothing, tasks: $author$project$Tasks$dummyTasks},
	$elm$core$Platform$Cmd$none);
...
var $author$project$Tasks$Add = {$: 'Add'};
var $author$project$Tasks$Edit = {$: 'Edit'};
...
var $author$project$Utils$unreachable = $elm$core$Debug$log('error - this code path should be unreachable');
var $author$project$Tasks$updateTaskInTask = F3(
	function (updateFn, path, task) {
		if (!path.b) {
			...
			if (task.$ === 'BranchTask') {
				...
				return $author$project$Tasks$BranchTask(
					_Utils_update(
						task_,
						{
							subtasks: A3($author$project$Tasks$updateTaskInTasklist, updateFn, path, task_.subtasks)
						}));
			} else {
				return $author$project$Utils$unreachable(task);
			}
		}
	});
var $author$project$Tasks$updateTaskInTasklist = F3(
	function (updateFn, path, tasklist) {
		if (path.b) {
			var idx = path.a;
			var pathRest = path.b;
			var _v1 = A2($elm$core$Array$get, idx, tasklist);
			if (_v1.$ === 'Just') {
				var task = _v1.a;
				return A3(
					$elm$core$Array$set,
					idx,
					A3($author$project$Tasks$updateTaskInTask, updateFn, pathRest, task),
					tasklist);
			} else {
				return $author$project$Utils$unreachable(tasklist);
			}
		} else {
			return $author$project$Utils$unreachable(tasklist);
		}
...
var $author$project$Tasks$addTask = F2(
	function (newTaskName, path) {
		var addTaskToTask = A2(
				...
				function (task) {
					return _Utils_update(
						task,
						{
							subtasks: A2(
								$elm$core$Array$push,
								$author$project$Tasks$newTask(newTaskName),
								task.subtasks)
						});
				},
				function (task) {
					return {expanded: false, name: task.name, subtasks: $elm$core$Array$empty};
				}),
			$author$project$Tasks$BranchTask);
		return $elm$core$List$isEmpty(path) ? $elm$core$Array$push(
			$author$project$Tasks$newTask(newTaskName)) : A2($author$project$Tasks$updateTaskInTasklist, addTaskToTask, path);
	});
var $author$project$Tasks$leafToBranch = function (task) {
	return {expanded: false, name: task.name, subtasks: $elm$core$Array$empty};
};
...
var $author$project$Utils$mapArrayAt = F3(
	function (mapper, idx, array) {
		var length = $elm$core$Array$length(array);
		var aMapped = A2(
			$elm$core$Maybe$map,
			mapper,
			A2($elm$core$Array$get, idx, array));
		var a2 = A3($elm$core$Array$slice, idx + 1, length, array);
		var a1 = A3($elm$core$Array$slice, 0, idx, array);
		if (aMapped.$ === 'Just') {
			var val = aMapped.a;
			return A2(
				$elm$core$Array$append,
				A2($elm$core$Array$push, val, a1),
				a2);
		} else {
			return A2($elm$core$Array$append, a1, a2);
		}
	});
var $author$project$Utils$removeFromArray = F2(
	function (i, a) {
		var a2 = A3(
...
var $author$project$Tasks$removeTask = F2(
	function (path, tasklist) {
		if (!path.b) {
			return $author$project$Utils$unreachable(tasklist);
		} else {
			var x = path.a;
			var xs = path.b;
			return $elm$core$List$isEmpty(xs) ? A2($author$project$Utils$removeFromArray, x, tasklist) : A3(
				$author$project$Utils$mapArrayAt,
				A2(
					$elm$core$Basics$composeR,
					A2(
						$author$project$Tasks$mapTask,
						function (task) {
							return _Utils_update(
								task,
								{
									subtasks: A2($author$project$Tasks$removeTask, xs, task.subtasks)
								});
						},
						A2($elm$core$Basics$composeL, $author$project$Utils$unreachable, $author$project$Tasks$leafToBranch)),
					$author$project$Tasks$BranchTask),
				x,
				tasklist);
		}
	});
var $author$project$Tasks$toggleExpand = $author$project$Tasks$updateTaskInTasklist(
	A2(
		$elm$core$Basics$composeR,
		A2(
			$author$project$Tasks$mapTask,
			...
			A2($elm$core$Basics$composeL, $author$project$Utils$unreachable, $author$project$Tasks$leafToBranch)),
		$author$project$Tasks$BranchTask));
var $author$project$Tasks$updateEditText = F2(
	function (newText, editingTask) {
		return _Utils_update(
			editingTask,
			{text: newText});
	});
var $author$project$Tasks$setName = F2(
...
var $author$project$Tasks$updateTask = function (newTaskName) {
	return $author$project$Tasks$updateTaskInTasklist(
		$author$project$Tasks$setName(newTaskName));
};
		...
		if (msg.$ === 'NoOp') {
			...
			switch (msg.a.$) {
				case 'ToggleExpandTask':
					var path = msg.a.a;
					var tasks = A2($author$project$Tasks$toggleExpand, path, model.tasks);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{tasks: tasks}),
				...
				case 'CommitEditTask':
					var _v1 = msg.a;
					var _v2 = model.editingTask;
					if (_v2.$ === 'Just') {
						var editType = _v2.a.editType;
						var path = _v2.a.path;
						var text = _v2.a.text;
						if (editType.$ === 'Add') {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										editingTask: $elm$core$Maybe$Nothing,
										tasks: A3($author$project$Tasks$addTask, text, path, model.tasks)
									}),
								$elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										editingTask: $elm$core$Maybe$Nothing,
										tasks: A3($author$project$Tasks$updateTask, text, path, model.tasks)
									}),
								$elm$core$Platform$Cmd$none);
						}
					} else {
				...
				case 'StartEditTask':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								editingTask: $elm$core$Maybe$Just(
									{editType: $author$project$Tasks$Edit, path: path, text: name})
							}),
						$elm$core$Platform$Cmd$none);
				case 'StartAddTask':
					var path = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								editingTask: $elm$core$Maybe$Just(
									{editType: $author$project$Tasks$Add, path: path, text: ''})
							}),
						$elm$core$Platform$Cmd$none);
				case 'CancelEditTask':
					var _v5 = msg.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								editingTask: A2(
									$elm$core$Maybe$map,
									$author$project$Tasks$updateEditText(newText),
									model.editingTask)
							}),
						$elm$core$Platform$Cmd$none);
				case 'DeleteTask':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								tasks: A2($author$project$Tasks$removeTask, path, model.tasks)
							}),
						$elm$core$Platform$Cmd$none);
				case 'TaskToLeaf':
					var path = msg.a.a;
...
var $author$project$Main$TaskMsg = function (a) {
	return {$: 'TaskMsg', a: a};
};
...
var $author$project$Icon$Add = {$: 'Add'};
var $author$project$Tasks$CancelEditTask = {$: 'CancelEditTask'};
var $author$project$Tasks$CommitEditTask = {$: 'CommitEditTask'};
var $author$project$Tasks$DeleteTask = function (a) {
	return {$: 'DeleteTask', a: a};
};
var $author$project$Tasks$StartAddTask = function (a) {
	return {$: 'StartAddTask', a: a};
};
var $author$project$Tasks$StartEditTask = F2(
	function (a, b) {
		return {$: 'StartEditTask', a: a, b: b};
	});
var $author$project$Style$TextButton = {$: 'TextButton'};
var $author$project$Tasks$ToggleExpandTask = function (a) {
	return {$: 'ToggleExpandTask', a: a};
};
var $author$project$Tasks$UpdateEditText = function (a) {
	return {$: 'UpdateEditText', a: a};
};
...
var $author$project$Tasks$addingToThisTasklist = $elm$core$Maybe$andThen(
	function (editingTask) {
		return (_Utils_eq(editingTask.editType, $author$project$Tasks$Add) && $elm$core$List$isEmpty(editingTask.path)) ? $elm$core$Maybe$Just(editingTask.text) : $elm$core$Maybe$Nothing;
	});
...
var $author$project$Icon$toString = function (iconType) {
	switch (iconType.$) {
		case 'Add':
			return 'add';
		case 'ExpandLess':
...
var $author$project$Icon$el2 = F2(
	function (attrs, iconType) {
		return A2(
			...
			A2(
				...
				A2(
					...
					$mdgriffith$elm_ui$Element$Font$family(
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$typeface('Material Icons')
							])),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$Font$regular,
						A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Font$unitalicized, attrs)))),
			$mdgriffith$elm_ui$Element$text(
				$author$project$Icon$toString(iconType)));
	});
...
var $author$project$Style$secondary = A3($mdgriffith$elm_ui$Element$rgb255, 156, 39, 176);
...
var $author$project$Style$button = F2(
	function (attrs, params) {
		var text = $mdgriffith$elm_ui$Element$text(
			$elm$core$String$toUpper(params.label));
		var styles = function () {
			var _v2 = params.decoration;
			switch (_v2.$) {
				case 'FillButton':
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color($author$project$Style$secondary),
				...
				default:
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color($author$project$Style$secondary)
						]);
			}
		}();
		...
		var padding = $mdgriffith$elm_ui$Element$paddingEach(
			{bottom: 0, left: paddingLeft, right: 16, top: 0});
		var inner = function () {
			var _v0 = params.icon;
			if (_v0.$ === 'Just') {
				var icon = _v0.a;
				return A2(
					...
					_List_fromArray(
						[
							A2($author$project$Icon$el2, _List_Nil, icon),
							text
						]));
			} else {
				return text;
		...
		return A2(
			...
			{label: inner, onPress: params.onPress});
	});
...
var $author$project$Tasks$editingThisTask = $elm$core$Maybe$andThen(
	function (editingTask) {
		return (_Utils_eq(editingTask.editType, $author$project$Tasks$Edit) && $elm$core$List$isEmpty(editingTask.path)) ? $elm$core$Maybe$Just(editingTask.text) : $elm$core$Maybe$Nothing;
	});
var $author$project$Tasks$fill = $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill);
var $author$project$Tasks$indent = function (amt) {
	return $mdgriffith$elm_ui$Element$paddingEach(
		{bottom: 0, left: amt, right: 0, top: 0});
};
...
var $author$project$Tasks$name = function (task) {
	if (task.$ === 'BranchTask') {
		var task_ = task.a;
		return task_.name;
	} else {
...
var $author$project$Tasks$taskExpanded = A2(
	$author$project$Tasks$mapTask,
	function (t) {
		return t.expanded;
	},
...
var $author$project$Tasks$taskPadding = $mdgriffith$elm_ui$Element$padding(5);
var $author$project$Icon$Cancel = {$: 'Cancel'};
var $mdgriffith$elm_ui$Internal$Model$unstyled = A2($elm$core$Basics$composeL, $mdgriffith$elm_ui$Internal$Model$Unstyled, $elm$core$Basics$always);
var $mdgriffith$elm_ui$Element$html = $mdgriffith$elm_ui$Internal$Model$unstyled;
var $author$project$Icon$icon_ = function (iconType) {
...
var $author$project$Icon$button = F3(
	function (attrs, iconType, onPress) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			attrs,
			{
				label: $author$project$Icon$icon_(iconType),
				onPress: onPress
			});
	});
var $author$project$Icon$el = F2(
	function (attrs, iconType) {
		return $author$project$Icon$icon_(iconType);
	});
...
var $author$project$Tasks$viewTaskEditor = F2(
	function (attrs, params) {
		var cancelButton = function () {
			var _v0 = params.onCancel;
			if (_v0.$ === 'Just') {
				var onCancel_ = _v0.a;
				return A3(
					$author$project$Icon$button,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$padding(5)
						]),
					$author$project$Icon$Cancel,
					$elm$core$Maybe$Just(onCancel_));
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						label: $mdgriffith$elm_ui$Element$Input$labelHidden('new task name'),
					...
					{
						label: A2($author$project$Icon$el, _List_Nil, $author$project$Icon$Add),
						onPress: $elm$core$String$isEmpty(params.text) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(params.onCommit)
					})
				]));
	});
var $author$project$Icon$Edit = {$: 'Edit'};
var $author$project$Icon$ExpandLess = {$: 'ExpandLess'};
var $author$project$Icon$ExpandMore = {$: 'ExpandMore'};
var $author$project$Icon$blank = function (attrs) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		attrs,
		A2(
...
var $author$project$Tasks$viewTaskText = F2(
	function (attrs, _v0) {
		var onEdit = _v0.onEdit;
		var onDelete = _v0.onDelete;
		var onToggleExpand = _v0.onToggleExpand;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Icon$button,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight, $author$project$Tasks$taskPadding]),
					$author$project$Icon$Edit,
					$elm$core$Maybe$Just(onEdit)),
					A3(
					$author$project$Icon$button,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight, $author$project$Tasks$taskPadding]),
					...
					function () {
					if (expanded.$ === 'Just') {
						var expanded_ = expanded.a;
						var icon_ = expanded_ ? $author$project$Icon$ExpandMore : $author$project$Icon$ExpandLess;
						return A3(
							$author$project$Icon$button,
							_List_fromArray(
								[$author$project$Tasks$taskPadding, $mdgriffith$elm_ui$Element$alignRight]),
							icon_,
							$elm$core$Maybe$Just(onToggleExpand));
					} else {
						return $author$project$Icon$blank(
							_List_fromArray(
								[$author$project$Tasks$taskPadding]));
					}
				}()
				]));
	});
var $author$project$Tasks$viewTask = F4(
	function (attrs, editingTask, path, task) {
		var viewSubtasks = function (attrs_) {
			if (task.$ === 'BranchTask') {
				var task_ = task.a;
				return task_.expanded ? A4(
					$author$project$Tasks$viewTasklist,
					_List_fromArray(
						[$author$project$Tasks$fill]),
					editingTask,
					path,
					task_.subtasks) : $mdgriffith$elm_ui$Element$none;
			} else {
				var task_ = task.a;
				return $mdgriffith$elm_ui$Element$none;
			}
		...
		var textView = function () {
			var _v3 = $author$project$Tasks$editingThisTask(editingTask);
			if (_v3.$ === 'Just') {
				var text = _v3.a;
				return A2(
					$author$project$Tasks$viewTaskEditor,
					_List_fromArray(
						[$author$project$Tasks$fill]),
					{
						onCancel: $elm$core$Maybe$Just($author$project$Tasks$CancelEditTask),
						onChange: $author$project$Tasks$UpdateEditText,
						onCommit: $author$project$Tasks$CommitEditTask,
						text: text
					});
			} else {
				return A2(
					$author$project$Tasks$viewTaskText,
					_List_fromArray(
						[$author$project$Tasks$fill]),
					{
						expanded: A3(
							$author$project$Tasks$mapTask,
							function (t) {
								return $elm$core$Maybe$Just(t.expanded);
							},
							function (_v4) {
								return $elm$core$Maybe$Nothing;
							},
							task),
						onDelete: $author$project$Tasks$DeleteTask(path),
						onEdit: A2(
							$author$project$Tasks$StartEditTask,
							$author$project$Tasks$name(task),
							path),
						onToggleExpand: $author$project$Tasks$ToggleExpandTask(path),
						text: $author$project$Tasks$name(task)
					});
			}
		}();
		var branchAttrs = $author$project$Tasks$taskExpanded(task) ? _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$width(1),
				$mdgriffith$elm_ui$Element$Border$color(
		...
		return A2(
			...
			A2($elm$core$List$cons, $author$project$Tasks$fill, branchAttrs),
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$author$project$Tasks$fill, $author$project$Tasks$taskPadding]),
					textView),
					viewSubtasks(
					_List_fromArray(
...
var $author$project$Tasks$viewTasklist = F4(
	function (attrs, editingTask, path, tasklist) {
		var editingTaskForTask = function (index) {
			if (editingTask.$ === 'Just') {
				var editingTask_ = editingTask.a;
				var _v2 = editingTask_.path;
				if (!_v2.b) {
					return $elm$core$Maybe$Nothing;
				} else {
					var x = _v2.a;
					var xs = _v2.b;
					return _Utils_eq(index, x) ? $elm$core$Maybe$Just(
						_Utils_update(
							editingTask_,
							{path: xs})) : $elm$core$Maybe$Nothing;
				}
			} else {
				return $elm$core$Maybe$Nothing;
			}
		...
		var addTaskView = function () {
			var _v0 = $author$project$Tasks$addingToThisTasklist(editingTask);
			if (_v0.$ === 'Just') {
				var text = _v0.a;
				return A2(
					$author$project$Tasks$viewTaskEditor,
				...
				return A2(
					...
					_List_Nil,
					{
						decoration: $author$project$Style$TextButton,
						icon: $elm$core$Maybe$Just($author$project$Icon$Add),
						label: 'Add task',
						onPress: $elm$core$Maybe$Just(
							$author$project$Tasks$StartAddTask(path))
					});
			}
		}();
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Tasks$indent(20),
				attrs),
			$elm$core$Array$toList(
				A2(
					$elm$core$Array$push,
					addTaskView,
					A2($elm$core$Array$indexedMap, mapper, tasklist))));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('My Tasks')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$author$project$Main$TaskMsg,
				A4($author$project$Tasks$viewTasklist, _List_Nil, model.editingTask, _List_Nil, model.tasks))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Tasks.Path":{"args":[],"type":"List.List Basics.Int"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"TaskMsg":["Tasks.Msg"]}},"Tasks.Msg":{"args":[],"tags":{"ToggleExpandTask":["Tasks.Path"],"DeleteTask":["Tasks.Path"],"UpdateEditText":["String.String"],"StartAddTask":["Tasks.Path"],"StartEditTask":["String.String","Tasks.Path"],"CancelEditTask":[],"CommitEditTask":[],"TaskToLeaf":["Tasks.Path"],"TaskToBranch":["Tasks.Path"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));